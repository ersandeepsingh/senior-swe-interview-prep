...
# LeetCode: 904
# Difficulty: Medium
# Pattern: Window with at-most-k constraint
#
# Problem:
...
# If we start at the first tree, we would only pick from trees [0, 1].
#
# Example 3:
# Input: fruits = [1, 2, 3, 2, 2]
# Output: 4
# Explanation: We can pick from trees [2, 3, 2, 2].
# If we start at the first tree, we would only pick from trees [1, 2].
#
# Constraints:
