...
# LeetCode: 452
# Difficulty: Medium
# Pattern: Balloon bursting (min arrows)
#
# Problem:
...
# denotes a balloon whose horizontal diameter stretches between x_start and x_end. You do not
...
# along the x-axis. A balloon with x_start and x_end is burst by an arrow shot at x if
# x_start <= x <= x_end. There is no limit to the number of arrows that can be shot. A shot
...
if __name__ == '__main__':
    ...
    ans = find_min_arrow_shots(points)
    print(ans)
